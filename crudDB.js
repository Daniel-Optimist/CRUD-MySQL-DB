...
3)fields:provides metadata about the result set returned, such as field names and types.Not always used, but can be helpful for understanding the structure of the returned data.
*/
...
// 	//DKG: the values in array form assigned to their corresponding variable name 
// 	let valueName = [name]
// 	let valueAddress = [address]
// 	let valueCompany = [company]
